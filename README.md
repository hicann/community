...
参与 CANN 社区代码贡献时，提交 PR 前需完成开发环境准备，并仔细了解项目特定的开发规范和版权声明要求（如涉及开源代码片段引用，请参考[片段引用指导](contributor/third_party/snippet-reference-guideline.md)），确保您的贡献符合项目标准。具体操作步骤请参阅：[PR 操作指南](contributor/pull_request_operation.md)。
