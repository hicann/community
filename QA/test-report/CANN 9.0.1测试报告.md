...
版本新增特性、修复问题请参考release-nodes：https://gitcode.com/cann/release-management/blob/master/9.0.1/release-notes.md
...
**本次发版本，共计执行28.5k测试用例，未发现问题。无遗留问题，整体质量良好，满足出口质量标准。**
...
### 5.1 安全测试
1. 该版本整体安全测试结论为通过；
2. 该版本继承CANN 9.0.0商发版本的fuzz测试、端口扫描均通过的结论；
3. 该版本合入的bugfix经评估对安全无影响；
4. 其余安全测试项的结论如下：


| 序号  | 测试项                       |安全性特性   |测试结论   |遗留风险   |
|-----|--------------------------| ------------ | ------------ |------------   |
| 1   | 静态代码扫描               |Pass |Pass   |无 |
| 2   | 病毒扫描                |Pass |Pass   |无 |
| 3   | 安全配置            |Pass |Pass   |无 |
| 4   | 编译选项              |Pass |Pass   |无 |
| 5   | 安全漏洞扫描              |Pass |Pass   |无 |
...
| ------------ | ------------ | ------------ |------------|------------|
|  算子 |pass   |855   | 100%   | 100% |
|  cann 多OS|pass |1320  | 100%   | 100% |
|  atb |pass   |3456   | 100%   | 100% |
|  HCCL |pass   |765   | 100%   | 100% |

### 6.1.3 全量测试

| 测试活动   |测试结论   |用例数   |用例覆盖率   |用例通过率
| ------------ | ------------ | ------------ |------------|------------|
|  算子 |pass   |8877   | 100%   | 100% |
|  cann 多OS|pass |8771  | 100%   | 100% |
|  atb |pass   |1823   | 100%   | 100% |
|  HCCL |pass   |1769   | 100%   | 100% |
...
|  头文件静态测试 |pass |1  | 100%   | 100% |
|  独立升级兼容性 |pass   |5   | 100%   | 100% |
|  二进制一致性 |pass   |1   | 100%   | 100% |
|  合包测试 |pass   | 4   | 100%   | 100% |
