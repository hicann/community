...
2）项目管理委员会主席的退出：项目管理委员会主席如果需要在任期届满前卸任，需提前 30 个工作日通过邮件等书面方式通知 CANN 技术指导委员会，由技术指导委员会负责协调重新选举项目管理委员会主席；
...
1）三分之二以上（含）项目管理委员会委员与会的会议为有效会议；与会形式包括现场与会、线上接入等可以核实身份的多种形式；
